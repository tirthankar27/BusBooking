...
<head>
    ...
    <title> <?php echo $source . " to " . $dest; ?> </title>
...
<body>
    ...
    <main class="flex justify-center items-center">
        <?php if ($source == 'Ravangla' && $dest == 'Silliguri'): ?>
        ...
        <?php elseif ($source == 'Silliguri' && $dest == 'Ravangla'): ?>
            <div class="flex flex-row justify-center items-center mt-48 bg-green-300 h-auto w-11/12 rounded-lg shadow-lg p-4">
                <div class="h-full w-1/4 overflow-hidden rounded-lg">
        ...
        <?php else: ?>
            <h1 class="text-green-700 text-5xl mt-56">Sorry We don't serve to these locations yet! 😞</h1>
        <?php endif; ?>
    </main>
</body>
